...
% Tue Nov 14 11:49:44 2017
\begin{table}[ht]
\centering
\begin{tabular}{r|L{4cm}|L{4cm}|L{4cm}|L{4cm}}
  \toprule
 & 1 & 2 & 3 & 4 \\ 
  \midrule
Alisa Alekseenko &  &  &  &  \\ 
   \rowcolor[gray]{0.95}Berrit Kiehl &  &  &  &  \\ 
  Chayan Kumar Saha &  &  &  &  \\ 
   \rowcolor[gray]{0.95}Fazeelat Karamat &  &  &  &  \\ 
  Giulia Gaudenzi &  &  &  &  \\ 
   \rowcolor[gray]{0.95}Hongya Han &  &  &  &  \\ 
  Huthayfa Mujahed &  &  &  &  \\ 
   \rowcolor[gray]{0.95}Jonas Sondergaard &  &  &  &  \\ 
  Keyi Geng &  &  &  &  \\ 
   \rowcolor[gray]{0.95}Marco Cavalli &  &  &  &  \\ 
  Ram Vinay Pandey &  &  &  &  \\ 
   \rowcolor[gray]{0.95}Roshan Vaid &  &  &  &  \\ 
  Sylvain Mareschal &  &  &  &  \\ 
   \rowcolor[gray]{0.95}Tatiana Kan &  &  &  &  \\ 
   \bottomrule
\end{tabular}
\end{table}
